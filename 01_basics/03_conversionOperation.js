...
// "33" => 33
// "33abc" => NaN (not a number) pr iska datatype number hi hota hai (if a string like this or anything that can't be turned into number will display then NaN)
// true => 1; false => 0
...
// "hitesh" => true (string with value will always display true)
