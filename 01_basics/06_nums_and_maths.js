...
console.log(balance.toString()) // since number has very few prototype properties so now it also has all the string prototype properties
...
console.log(Math.abs(-4)) // negative sign remove krdega and will always give +ve value, will give 4 as output 
...
console.log(Math.random()) // koi bhi random number display krdega but the number will always be between 0 and 1 in which 1 is excluded i.e max: 0.999..
